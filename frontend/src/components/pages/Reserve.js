...
const Reserve = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch('http://localhost:1337/api/reserves', {
        method: 'POST',
    ...
    <Box sx={styles.container}>
      ...
      <Box sx={styles.mainBox}>
        <Box sx={styles.rightContainer}>
          ...
          <img
            src={"http://localhost:1337/uploads/reserve_1_58834a3bb3.jpg"}
            alt='Sofa'
            width='100%'
            height='360'
        ...
        <Box sx={styles.leftContainer}>
          ...
          <img
            src={"http://localhost:1337/uploads/reserve_2_6a5455c8c5.jpg"}
            alt='Billiard'
            width='100%'
            height='360'
            style={{ borderRadius: 15 }}
